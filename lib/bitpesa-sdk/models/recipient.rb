...
module Bitpesa
  ...
  class Recipient
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requested_amount')
        self.requested_amount = attributes[:'requested_amount']
      end

      if attributes.has_key?(:'requested_currency')
        self.requested_currency = attributes[:'requested_currency']
      end

      if attributes.has_key?(:'payout_method')
      ...
      if attributes.has_key?(:'input_usd_amount')
        self.input_usd_amount = attributes[:'input_usd_amount']
      end

      if attributes.has_key?(:'may_cancel')
        self.may_cancel = attributes[:'may_cancel']
      end

      if attributes.has_key?(:'state_reason')
      ...
      if attributes.has_key?(:'fee_fractional')
        self.fee_fractional = attributes[:'fee_fractional']
      end

      if attributes.has_key?(:'input_amount')
        self.input_amount = attributes[:'input_amount']
      end

      if attributes.has_key?(:'input_currency')
        self.input_currency = attributes[:'input_currency']
      end

      if attributes.has_key?(:'output_amount')
        self.output_amount = attributes[:'output_amount']
      end

      if attributes.has_key?(:'output_currency')
