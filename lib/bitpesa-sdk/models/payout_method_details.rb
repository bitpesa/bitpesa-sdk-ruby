...
module Bitpesa
  class PayoutMethodDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mobile_provider')
      ...
      if attributes.has_key?(:'identity_card_type')
        self.identity_card_type = attributes[:'identity_card_type']
      end

      if attributes.has_key?(:'identity_card_id')
