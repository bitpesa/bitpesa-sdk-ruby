...
module Bitpesa
  ...
  class Transaction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payin_methods')
      ...
      if attributes.has_key?(:'payin_reference')
        self.payin_reference = attributes[:'payin_reference']
      end

      if attributes.has_key?(:'paid_amount')
        self.paid_amount = attributes[:'paid_amount']
      end

      if attributes.has_key?(:'due_amount')
