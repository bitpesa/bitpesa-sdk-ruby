...
# Unit tests for Bitpesa::WebhookLogBaseMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookLogBaseMetadata' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookLogBaseMetadata.new
  end
  ...
  describe 'test an instance of WebhookLogBaseMetadata' do
    it 'should create an instance of WebhookLogBaseMetadata' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookLogBaseMetadata)
    end
  end
