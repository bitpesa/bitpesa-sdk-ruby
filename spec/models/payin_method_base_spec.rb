...
# Unit tests for Bitpesa::PayinMethodBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayinMethodBase' do
  before do
    # run before each test
    @instance = Bitpesa::PayinMethodBase.new
  end
  ...
  describe 'test an instance of PayinMethodBase' do
    it 'should create an instance of PayinMethodBase' do
      expect(@instance).to be_instance_of(Bitpesa::PayinMethodBase)
    end
  end
