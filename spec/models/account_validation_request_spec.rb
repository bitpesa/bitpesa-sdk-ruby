...
# Unit tests for Bitpesa::AccountValidationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountValidationRequest' do
  before do
    # run before each test
    @instance = Bitpesa::AccountValidationRequest.new
  end
  ...
  describe 'test an instance of AccountValidationRequest' do
    it 'should create an instance of AccountValidationRequest' do
      expect(@instance).to be_instance_of(Bitpesa::AccountValidationRequest)
    end
  end
