...
# Unit tests for Bitpesa::PayinMethodTypeBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayinMethodTypeBase' do
  before do
    # run before each test
    @instance = Bitpesa::PayinMethodTypeBase.new
  end
  ...
  describe 'test an instance of PayinMethodTypeBase' do
    it 'should create an instance of PayinMethodTypeBase' do
      expect(@instance).to be_instance_of(Bitpesa::PayinMethodTypeBase)
    end
  end
