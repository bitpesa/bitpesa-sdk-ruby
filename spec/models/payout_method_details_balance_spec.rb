...
# Unit tests for Bitpesa::PayoutMethodDetailsBalance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayoutMethodDetailsBalance' do
  before do
    # run before each test
    @instance = Bitpesa::PayoutMethodDetailsBalance.new
  end
  ...
  describe 'test an instance of PayoutMethodDetailsBalance' do
    it 'should create an instance of PayoutMethodDetailsBalance' do
      expect(@instance).to be_instance_of(Bitpesa::PayoutMethodDetailsBalance)
    end
  end
