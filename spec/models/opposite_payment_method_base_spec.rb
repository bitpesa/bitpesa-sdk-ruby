...
# Unit tests for Bitpesa::OppositePaymentMethodBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OppositePaymentMethodBase' do
  before do
    # run before each test
    @instance = Bitpesa::OppositePaymentMethodBase.new
  end
  ...
  describe 'test an instance of OppositePaymentMethodBase' do
    it 'should create an instance of OppositePaymentMethodBase' do
      expect(@instance).to be_instance_of(Bitpesa::OppositePaymentMethodBase)
    end
  end
