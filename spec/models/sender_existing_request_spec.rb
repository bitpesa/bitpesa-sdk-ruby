...
# Unit tests for Bitpesa::SenderExistingRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SenderExistingRequest' do
  before do
    # run before each test
    @instance = Bitpesa::SenderExistingRequest.new
  end
  ...
  describe 'test an instance of SenderExistingRequest' do
    it 'should create an instance of SenderExistingRequest' do
      expect(@instance).to be_instance_of(Bitpesa::SenderExistingRequest)
    end
  end
