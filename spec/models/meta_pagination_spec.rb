...
# Unit tests for Bitpesa::MetaPagination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MetaPagination' do
  before do
    # run before each test
    @instance = Bitpesa::MetaPagination.new
  end
  ...
  describe 'test an instance of MetaPagination' do
    it 'should create an instance of MetaPagination' do
      expect(@instance).to be_instance_of(Bitpesa::MetaPagination)
    end
  end
