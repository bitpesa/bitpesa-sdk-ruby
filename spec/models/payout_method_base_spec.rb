...
# Unit tests for Bitpesa::PayoutMethodBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayoutMethodBase' do
  before do
    # run before each test
    @instance = Bitpesa::PayoutMethodBase.new
  end
  ...
  describe 'test an instance of PayoutMethodBase' do
    it 'should create an instance of PayoutMethodBase' do
      expect(@instance).to be_instance_of(Bitpesa::PayoutMethodBase)
    end
  end
