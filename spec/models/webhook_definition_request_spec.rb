...
# Unit tests for Bitpesa::WebhookDefinitionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookDefinitionRequest' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookDefinitionRequest.new
  end
  ...
  describe 'test an instance of WebhookDefinitionRequest' do
    it 'should create an instance of WebhookDefinitionRequest' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookDefinitionRequest)
    end
  end
