...
# Unit tests for Bitpesa::InlineResponse4227Meta
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse4227Meta' do
  before do
    # run before each test
    @instance = Bitpesa::InlineResponse4227Meta.new
  end
  ...
  describe 'test an instance of InlineResponse4227Meta' do
    it 'should create an instance of InlineResponse4227Meta' do
      expect(@instance).to be_instance_of(Bitpesa::InlineResponse4227Meta)
    end
  end
