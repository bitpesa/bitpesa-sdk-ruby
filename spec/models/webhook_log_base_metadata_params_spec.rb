...
# Unit tests for Bitpesa::WebhookLogBaseMetadataParams
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookLogBaseMetadataParams' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookLogBaseMetadataParams.new
  end
  ...
  describe 'test an instance of WebhookLogBaseMetadataParams' do
    it 'should create an instance of WebhookLogBaseMetadataParams' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookLogBaseMetadataParams)
    end
  end
