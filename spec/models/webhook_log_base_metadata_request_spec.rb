...
# Unit tests for Bitpesa::WebhookLogBaseMetadataRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookLogBaseMetadataRequest' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookLogBaseMetadataRequest.new
  end
  ...
  describe 'test an instance of WebhookLogBaseMetadataRequest' do
    it 'should create an instance of WebhookLogBaseMetadataRequest' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookLogBaseMetadataRequest)
    end
  end
