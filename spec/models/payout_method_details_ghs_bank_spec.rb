...
# Unit tests for Bitpesa::PayoutMethodDetailsGHSBank
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayoutMethodDetailsGHSBank' do
  before do
    # run before each test
    @instance = Bitpesa::PayoutMethodDetailsGHSBank.new
  end
  ...
  describe 'test an instance of PayoutMethodDetailsGHSBank' do
    it 'should create an instance of PayoutMethodDetailsGHSBank' do
      expect(@instance).to be_instance_of(Bitpesa::PayoutMethodDetailsGHSBank)
    end
  end
