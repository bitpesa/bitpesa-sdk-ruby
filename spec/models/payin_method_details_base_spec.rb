...
# Unit tests for Bitpesa::PayinMethodDetailsBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayinMethodDetailsBase' do
  before do
    # run before each test
    @instance = Bitpesa::PayinMethodDetailsBase.new
  end
  ...
  describe 'test an instance of PayinMethodDetailsBase' do
    it 'should create an instance of PayinMethodDetailsBase' do
      expect(@instance).to be_instance_of(Bitpesa::PayinMethodDetailsBase)
    end
  end
end
