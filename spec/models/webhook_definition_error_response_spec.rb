...
# Unit tests for Bitpesa::WebhookDefinitionErrorResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookDefinitionErrorResponse' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookDefinitionErrorResponse.new
  end
  ...
  describe 'test an instance of WebhookDefinitionErrorResponse' do
    it 'should create an instance of WebhookDefinitionErrorResponse' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookDefinitionErrorResponse)
    end
  end
