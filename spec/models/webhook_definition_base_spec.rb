...
# Unit tests for Bitpesa::WebhookDefinitionBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookDefinitionBase' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookDefinitionBase.new
  end
  ...
  describe 'test an instance of WebhookDefinitionBase' do
    it 'should create an instance of WebhookDefinitionBase' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookDefinitionBase)
    end
  end
