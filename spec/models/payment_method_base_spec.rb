...
# Unit tests for Bitpesa::PaymentMethodBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodBase' do
  before do
    # run before each test
    @instance = Bitpesa::PaymentMethodBase.new
  end
  ...
  describe 'test an instance of PaymentMethodBase' do
    it 'should create an instance of PaymentMethodBase' do
      expect(@instance).to be_instance_of(Bitpesa::PaymentMethodBase)
    end
  end
