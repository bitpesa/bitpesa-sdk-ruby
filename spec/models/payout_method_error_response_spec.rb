...
# Unit tests for Bitpesa::PayoutMethodErrorResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayoutMethodErrorResponse' do
  before do
    # run before each test
    @instance = Bitpesa::PayoutMethodErrorResponse.new
  end
  ...
  describe 'test an instance of PayoutMethodErrorResponse' do
    it 'should create an instance of PayoutMethodErrorResponse' do
      expect(@instance).to be_instance_of(Bitpesa::PayoutMethodErrorResponse)
    end
  end
