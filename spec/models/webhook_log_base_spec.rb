...
# Unit tests for Bitpesa::WebhookLogBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookLogBase' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookLogBase.new
  end
  ...
  describe 'test an instance of WebhookLogBase' do
    it 'should create an instance of WebhookLogBase' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookLogBase)
    end
  end
