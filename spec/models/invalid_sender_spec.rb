...
# Unit tests for BitPesa::InvalidSender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvalidSender' do
  before do
    # run before each test
    @instance = BitPesa::InvalidSender.new
  end
  ...
  describe 'test an instance of InvalidSender' do
    it 'should create an instance of InvalidSender' do
      expect(@instance).to be_instance_of(BitPesa::InvalidSender)
    end
  end
