...
# Unit tests for BitPesa::SenderValidResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SenderValidResponse' do
  before do
    # run before each test
    @instance = BitPesa::SenderValidResponse.new
  end
  ...
  describe 'test an instance of SenderValidResponse' do
    it 'should create an instance of SenderValidResponse' do
      expect(@instance).to be_instance_of(BitPesa::SenderValidResponse)
    end
  end
