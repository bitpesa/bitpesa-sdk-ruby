...
# Unit tests for BitPesa::DefaultSender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefaultSender' do
  before do
    # run before each test
    @instance = BitPesa::DefaultSender.new
  end
  ...
  describe 'test an instance of DefaultSender' do
    it 'should create an instance of DefaultSender' do
      expect(@instance).to be_instance_of(BitPesa::DefaultSender)
    end
  end
