...
# Unit tests for Bitpesa::WebhookDefinitionValidResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookDefinitionValidResponse' do
  before do
    # run before each test
    @instance = Bitpesa::WebhookDefinitionValidResponse.new
  end
  ...
  describe 'test an instance of WebhookDefinitionValidResponse' do
    it 'should create an instance of WebhookDefinitionValidResponse' do
      expect(@instance).to be_instance_of(Bitpesa::WebhookDefinitionValidResponse)
    end
  end
