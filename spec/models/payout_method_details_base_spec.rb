...
# Unit tests for Bitpesa::PayoutMethodDetailsBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayoutMethodDetailsBase' do
  before do
    # run before each test
    @instance = Bitpesa::PayoutMethodDetailsBase.new
  end
  ...
  describe 'test an instance of PayoutMethodDetailsBase' do
    it 'should create an instance of PayoutMethodDetailsBase' do
      expect(@instance).to be_instance_of(Bitpesa::PayoutMethodDetailsBase)
    end
  end
end
